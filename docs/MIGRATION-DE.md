...
Fur eine vollstandige Referenz aller verfugbaren Parameter siehe [VOICEMEETER-API-DE.md](VOICEMEETER-API-DE.md).
...
| Denoiser-Steuerung per Encoder | `XTouchVM.py` (Encoder 1 in Home-View) | Kann als `EncoderFunction` hinzugefugt werden (siehe [VOICEMEETER-API-DE.md](VOICEMEETER-API-DE.md)) |
